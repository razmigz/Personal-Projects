...
ggplot(ds, aes(x=Global_Sales, y=User_Score, color = Genre)) + geom_jitter(alpha=.3) + facet_grid(Genre~.) + theme(legend.position = "none") + scale_x_continuous(limits=c(0,10))
...
ggplot(ds, aes(x=Genre, y=User_Score,color = Genre)) + geom_boxplot() + theme(legend.position = "none") + theme(plot.subtitle = element_text(vjust = 1), 
