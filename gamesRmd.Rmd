...
ggplot(ds, aes(x=Global_Sales, y=User_Score, color = Genre)) + geom_jitter(alpha=.3) + facet_grid(Genre~.) + theme(legend.position = "none") + ggplot(ds, aes(x=Global_Sales, y=User_Score, color = Genre)) + geom_jitter(alpha=.3) + theme(legend.position = "none") + scale_x_discrete(limits=c(0:10)) 
